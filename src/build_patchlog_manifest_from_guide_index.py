...
def main() -> None:
    ...
    PREFIX_RULES: List[Tuple[str, str, str]] = [
        # --- DF (Data Files) categories ---
        ("/df/activities/",                "patchlog_latest_df_activities.json",              "df-activities"),
        ("/df/bounty-hunting/",            "patchlog_latest_df_bounty_hunting.json",          "df-bounty-hunting"),
        ...
        ("/df/cryptids/",                  "patchlog_latest_df_cryptids.json",                "df-cryptids"),
        ("/df/cult-of-the-lamb/",          "patchlog_latest_df_cult_of_the_lamb.json",        "df-cult-of-the-lamb"),
        ("/df/currency/",                  "patchlog_latest_df_currency.json",                "df-currency"),
        ("/df/data-mining/",              "patchlog_latest_df_data_mining.json",              "df-data-mining"),
        ("/df/events/",                    "patchlog_latest_df_events.json",                  "df-events"),
        ("/df/farming/",                   "patchlog_latest_df_farming.json",                 "df-farming"),
        ("/df/fishing/",                   "patchlog_latest_df_fishing.json",                 "df-fishing"),
        ("/df/minerva/",                   "patchlog_latest_df_minerva.json",                 "df-minerva"),
        ("/df/mini-seasons/",              "patchlog_latest_df_mini_seasons.json",            "df-mini-seasons"),
        ("/df/pet-taming/",                "patchlog_latest_df_pet_taming.json",              "df-pet-taming"),
        ("/df/plan-checklists/",           "patchlog_latest_df_plan_checklists.json",         "df-plan-checklists"),
        ("/df/public-events/",             "patchlog_latest_df_public_events.json",           "df-public-events"),
        ("/df/quests/",                    "patchlog_latest_df_quests.json",                  "df-quests"),
        ...
        ("/df/starfield/",                 "patchlog_latest_df_starfield.json",               "df-starfield"),
        ("/df/titles/",                    "patchlog_latest_titles.json",                     "df-titles"),
        ("/df/treasure-maps/",             "patchlog_latest_df_treasure_maps.json",           "df-treasure-maps"),
        ("/df/vendors/",                   "patchlog_latest_df_vendors.json",                 "df-vendors"),

        # --- BNB (Buffs n Brew) categories ---
        ...
        ("/bnb/curve-tables/",             "patchlog_latest_bnb_curve_tables.json",           "bnb-curve-tables"),
        ("/bnb/experience-xp/",            "patchlog_latest_bnb_experience.json",             "bnb-experience"),
        ("/bnb/farming/",                  "patchlog_latest_bnb_farming.json",                "bnb-farming"),
