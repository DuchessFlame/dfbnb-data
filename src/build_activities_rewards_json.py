...
def simplify_condition(cond_str):
    ...
    if "SDOW_MQ02_MapsAcquired" in s or ("GetStageDone" in s and "SDOW_MQ02_Graves" in s):
        ...
        return f"Can only drop if you have less than {_n} Pint-Sized Phantoms’ Maps in your Pip-Boy inventory"
        ...
        for rr in gmrw_rows:
            ...
            if kind.upper() == "LVLI":
                ...
                if is_regional_schematics:
                    ...
                    # GLOB slot, and LVLV (see lines ~1782-1829).  JS renders
                    # these as a "Drop Conditions:" row above the Technical
                    # block (df-bnb-activities.js line ~2627).
                    _is_pa_pool = (
