...
OVERLAY = {
    ...
    "AnyPet_PetKill01":       ("Have your active pet land the killing blow on hostiles.", ""),
    "AnyPet_PetKill02":       ("Have your active pet land the killing blow on hostiles.", ""),
    "AnyPet_PetKill03":       ("Have your active pet land the killing blow on hostiles.", ""),
