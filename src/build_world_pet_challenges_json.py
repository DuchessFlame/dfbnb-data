...
# ---------------------------------------------------------------------------
OVERLAY = {
    "AnyPet_ActivatePet01":   ("Open your Pip-Boy and activate a World Pet. Only one pet can be active at a time — this is the first thing you do with the system.", "10 Caps"),
    "AnyPet_GivePetCommand01":("Issue a command to your active pet (move / attack / interact).", "10 Caps"),
    "AnyPet_HealPet01":       ("Heal your active pet when it takes damage. Higher tiers require more heals.", ""),
    "AnyPet_HealPet02":       ("Heal your active pet when it takes damage. Higher tiers require more heals.", ""),
    "AnyPet_HealPet03":       ("Heal your active pet when it takes damage. Higher tiers require more heals.", ""),
    "AnyPet_PetKill01":       ("Have your active pet land the killing blow on hostiles. Higher tiers require more kills.", ""),
    "AnyPet_PetKill02":       ("Have your active pet land the killing blow on hostiles. Higher tiers require more kills.", ""),
    "AnyPet_PetKill03":       ("Have your active pet land the killing blow on hostiles. Higher tiers require more kills.", ""),
    "Cat_CatchFish01":        ("Catch fish while a Pet Cat is your active World Pet. Ties into the Cat's bait/fishing theme.", "100 Caps"),
    ...
    "Dog_BountyHunt01":       ("Complete Bounty Hunts while a Pet Dog is active. Ties into the Dog's Bounty Sniffer buff.", "100 Caps"),
    ...
    "Radhog_CollectFlux01":   ("Collect Flux while a Pet Radhog is active. Ties into the Radhog's nuke/flux theme.", "100 Caps"),
    ...
    "Deathclaw_InfestationKills01": ("Kill Infestation enemies while a Pet Deathclaw is active. Ties into the Deathclaw's Fun-Festation buff.", "100 Caps"),
