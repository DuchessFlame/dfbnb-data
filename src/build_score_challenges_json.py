#!/usr/bin/env python3
"""
build_score_challenges_json.py — Score Challenges
...
the Score Challenges-specific logic.

Usage: python build_score_challenges_json.py
"""
import subprocess, sys, os

def main():
    parent = os.path.join(os.path.dirname(__file__), "build_challenges_json_v3.py")
    print(f"[build_score_challenges_json.py] Delegating to {parent}")
