    ...
    output = {
        "byPage": {
            "infestations-all-rewards": {
                ...
                "gmrwFormID": "00888543",
                "type": "infestations",
                "description": "World Activity — not a public event. 7 enemy factions, 35 spawn locations across all regions, only 5 active at any time. Clear the infestation and defeat the boss to earn rewards.",
                "xp": xp,
                "caps": caps,
                "bossLoot": boss_loot,
                "mobLoot": mob_loot,
