...
====================
STATUS: SCAFFOLDED — gap filler for the Treasure Maps category.

NOTES FOR NEXT AI
─────────────────
1. This script should generate dist/treasure_maps.json from xEdit TSV exports.
...
4. EXPECTED OUTPUT:
   dist/treasure_maps.json — consumed by the JS module df-bnb-treasure_maps.js on the website

5. WORKFLOW:
   There is a matching GitHub Actions workflow:
   .github/workflows/build-treasure_maps.yml
...
Usage:
  ...
  python build_treasure_maps_json.py --tsv-root tsv --outdir dist
"""
...
def main():
    ...
    out_path = os.path.join("dist", "treasure_maps.json")
