...
# ONE image per pennant: the transparent _l render (the item on its own).
# The _c1/_c2 camp frames and the flat _d textures were the same art again
# and read as repeat pennants in Item Image, so they were retired (Sept 2026).
# Only Caravans and P68 fall back to their flat _d art — no _l render exists.
IMAGES_BY_ID = {
    "PENNANT_PTS": ["atx_camp_walldeco_pennant_pts_l"],
    "PENNANT_PATCH24PTS": ["atx_camp_walldeco_pennant_patch24pts_l"],
    "PENNANT_PATCH26PTS": ["atx_camp_walldeco_pennant_patch26pts_l"],
    "PENNANT_PTS_BOS": ["atx_camp_walldeco_pennant_pts_bos_l"],
    "PENNANT_PTS_WORLDS": ["atx_camp_walldeco_pennant_pts_worlds_l"],
    "PENNANT_PTS_MOTHMAN": ["atx_camp_walldeco_pennant_pts_mothman_l"],
    "PENNANT_PTS_INVADERS": ["atx_camp_walldeco_pennant_pts_invaders_l"],
    "PENNANT_NUCLEARWINTER": ["atx_camp_walldeco_pennant_nuclearwinter_l"],
    "PENNANT_PTS_TESTYOURMETAL": ["atx_camp_walldeco_pennant_pts_testyourmetal_l"],
    "PENNANT_PTS_PITT": ["atx_camp_walldeco_pennant_pts_pitt"],
    "PENNANT_PTS_NWOT": ["atx_camp_walldeco_pennant_pts_nwot_l"],
    "PENNANT_PTS_P42": ["atx_camp_walldeco_pennant_pts_p42"],
    "PENNANT_PTS_P44": ["atx_camp_walldeco_pennant_pts_p44__l"],
    "PENNANT_PTS_P46": ["atx_camp_walldeco_pennant_pts_p46_l"],
    "PENNANT_PTS_P48": ["atx_camp_walldeco_pennant_pts_p48_l"],
    "PENNANT_PTS_P50": ["atx_camp_walldeco_pennant_pts_p50"],
    "PENNANT_PTS_P52": ["atx_camp_walldeco_pennant_pts_p52_l"],
    "PENNANT_PTS_P54": ["atx_camp_walldeco_pennant_pts_p54_l"],
    "PENNANT_PTS_P56": ["atx_camp_walldeco_pennant_pts_p56_l"],
    "PENNANT_PTS_P58_COPY01": ["atx_camp_walldeco_pennant_pts_p58_l"],
    "PENNANT_PTS_P60": ["atx_camp_walldeco_pennant_pts_p60_l"],
    "PENNANT_PTS_P62": ["atx_camp_walldeco_pennant_pts_p62"],
    "PENNANT_MILE_ENTM_CAMP_WALLDECO_PENNANT_CARAVANS": ["p64_caravansshutdown_pennant_d"],
    "PENNANT_PTS_P64": ["atx_camp_walldeco_pennant_pts_p64"],
    "PENNANT_PTS_P66": ["atx_camp_walldeco_pennant_pts_p66_l"],
