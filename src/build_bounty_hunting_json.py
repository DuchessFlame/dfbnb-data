#!/usr/bin/env python3
"""
build_bounty_hunting_json.py — Bounty Hunting
...
the Bounty Hunting-specific logic.

Usage: python build_bounty_hunting_json.py
"""
import subprocess, sys, os

def main():
    parent = os.path.join(os.path.dirname(__file__), "build_reho_json.py")
    print(f"[build_bounty_hunting_json.py] Delegating to {parent}")
