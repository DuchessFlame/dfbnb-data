#!/usr/bin/env python3
"""
build_mini_seasons_json.py — Mini Seasons
...
the Mini Seasons-specific logic.

Usage: python build_mini_seasons_json.py
"""
import subprocess, sys, os

def main():
    parent = os.path.join(os.path.dirname(__file__), "build_challenges_json_v3.py")
    print(f"[build_mini_seasons_json.py] Delegating to {parent}")
