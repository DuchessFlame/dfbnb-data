...
GUIDE_ALIASES = {
    ...
    'nuka-cola':            ('Nuka Cola Guide',            '/bnb/farming/nuka-cola/nuka-cola-locations/'),
    'nuka-cherry':          ('Nuka Cola Cherry Guide',     '/bnb/farming/nuka-cola/cherry-locations/'),
    'nuka-grape':           ('Nuka Cola Grape Guide',      '/bnb/farming/nuka-cola/grape-locations/'),
    'nuka-orange':          ('Nuka Cola Orange Guide',     '/bnb/farming/nuka-cola/orange-locations/'),
    'nuka-cola quantum':    ('Nuka Cola Quantum Guide',    '/bnb/farming/nuka-cola/quantum-locations/'),
    'nuka-cola dark':       ('Nuka Cola Dark Guide',       '/bnb/farming/nuka-cola/dark-locations/'),
    'nuka-cola cranberry':  ('Nuka Cola Cranberry Guide',  '/bnb/farming/nuka-cola/cranberry-locations/'),
    'nuka-cola twist':      ('Nuka Cola Twist Guide',      '/bnb/farming/nuka-cola/twist-locations/'),
    'nuka-cola wild':       ('Nuka Cola Wild Guide',       '/bnb/farming/nuka-cola/wild-locations/'),
    ...
    'mothman egg':          ('Mothman Egg Guide',          '/bnb/farming/eggs/mothman/mothman-guide/'),
    'perfect mothman egg':  ('Mothman Egg Guide',          '/bnb/farming/eggs/mothman/mothman-guide/'),

    # ── Meat with "Meat" suffix in condition name ──
    'opossum meat':         ('Opossum Meat Guide',         '/bnb/farming/meat/opossum/opossum-location-guide/'),
    'queen mirelurk meat':  ('Mirelurk Queen Meat Guide',  '/bnb/farming/meat/mirelurk-queen/mirelurk-queen-location-guide/'),
    'brahmin milk':         ('Brahmin Meat Guide',         '/bnb/farming/meat/brahmin/brahmin-location-guide/'),

    # ── Creature race names → meat guides ──
    'honey beast':          ('Honey Guide',                '/bnb/farming/non-perishable/honey/honey-guide/'),
    'feral ghoul':          ('Glowing Meat Guide',         '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'wild mongrel':         ('Mongrel Dog Meat Guide',     '/bnb/farming/meat/mongrel-dog/mongrel-dog-location-guide/'),
    'super mutant':         ('Glowing Meat Guide',         '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'wendigo colossus':     ('Glowing Meat Guide',         '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'mirelurk hunter':      ('Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    'mirelurk king':        ('Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    'mirelurk spawn':       ('Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    ...
    'radturkey':            ('Radstag Meat Guide',         '/bnb/farming/meat/radstag/radstag-location-guide/'),
    'radant':               ('Rad Ant Meat Guide',         '/bnb/farming/insects/rad-ant/rad-ant-location-guide/'),

    # ── Big Bloom creatures ──
    'overgrown pollinator': ('Honey Guide',                '/bnb/farming/non-perishable/honey/honey-guide/'),
    'overgrown tank':       ('Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    'overgrown thorn':      ('Glowing Meat Guide',         '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'lesser devil':         ('Honey Guide',                '/bnb/farming/non-perishable/honey/honey-guide/'),
    'blue devil':           ('Honey Guide',                '/bnb/farming/non-perishable/honey/honey-guide/'),
    'the beast of beckley': ('Honey Guide',                '/bnb/farming/non-perishable/honey/honey-guide/'),
    ...
    'sugar':                ('Sugar Guide',                '/bnb/farming/non-perishable/salt-pepper-spices-sugar/salt-pepper-spices-sugar-guide/'),

    # ── Radtoad → egg guide (toad challenges are usually egg-related) ──
    'radtoad':              ('Radtoad Egg Guide',          '/bnb/farming/eggs/radtoad/radtoad-guide/'),

    # ── Fanatics ──
    'fanatics faction':     ('Glowing Meat Guide',         '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
}
...
KEYWORD_GUIDES = {
    ...
    # Creatures
    'ActorTypeWendigo':        ('Glowing Meat Guide',       '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'ActorTypeWendigoColossus':('Glowing Meat Guide',       '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'ActorTypeWendigoSpawn':   ('Glowing Meat Guide',       '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'ActorTypeGlowing':        ('Glowing Meat Guide',       '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'ActorTypeFloaterGnasher': ('Glowing Meat Guide',       '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    'ActorTypeOvergrown':      ('Honey Guide',              '/bnb/farming/non-perishable/honey/honey-guide/'),
    'ActorTypeCryptid':        ('Mothman Egg Guide',        '/bnb/farming/eggs/mothman/mothman-guide/'),
...
_NAME_KEYWORDS = [
    ...
    ('mirelurk queen',    'Mirelurk Queen Meat Guide',  '/bnb/farming/meat/mirelurk-queen/mirelurk-queen-location-guide/'),
    ('mirelurk king',     'Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    ('mirelurk hunter',   'Mirelurk Meat Guide',        '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    ('cave cricket',      'Cave Cricket Meat Guide',     '/bnb/farming/insects/cave-cricket/cave-cricket-location-guide/'),
    ('fog crawler',       'Fog Crawler Meat Guide',      '/bnb/farming/insects/fog-crawler/fog-crawler-location-guide/'),
    ('feral ghoul',       'Glowing Meat Guide',          '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('super mutant',      'Glowing Meat Guide',          '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('mega sloth',        'Megasloth Meat Guide',        '/bnb/farming/meat/megasloth/megasloth-location-guide/'),
    ('mongrel dog',       'Mongrel Dog Meat Guide',      '/bnb/farming/meat/mongrel-dog/mongrel-dog-location-guide/'),
    ('honey beast',       'Honey Guide',                 '/bnb/farming/non-perishable/honey/honey-guide/'),
    ('hermit crab',       'Hermit Crab Meat Guide',      '/bnb/farming/meat/hermit-crab/hermit-crab-location-guide/'),
    ('mole rat',          'Mole Rat Meat Guide',         '/bnb/farming/meat/mole-rat/mole-rat-location-guide/'),
    ('yao guai',          'Yao Guai Meat Guide',         '/bnb/farming/meat/yao-guai/yao-guai-location-guide/'),
    ('wendigo colossus',  'Glowing Meat Guide',          '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('grafton monster',   'Glowing Meat Guide',          '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('mutant hound',      'Mongrel Dog Meat Guide',      '/bnb/farming/meat/mongrel-dog/mongrel-dog-location-guide/'),
    # Single-word creatures
    ('deathclaw',         'Deathclaw Meat Guide',        '/bnb/farming/meat/deathclaw/deathclaw-location-guide/'),
    ('mirelurk',          'Mirelurk Meat Guide',         '/bnb/farming/meat/mirelurk/mirelurk-location-guide/'),
    ('radscorpion',       'Radscorpion Meat Guide',      '/bnb/farming/insects/radscorpion/radscorpion-location-guide/'),
    ('scorchbeast',       'Scorchbeast Meat Guide',      '/bnb/farming/meat/scorchbeast/scorchbeast-location-guide/'),
    ('snallygaster',      'Glowing Meat Guide',          '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('brahmin',           'Brahmin Meat Guide',           '/bnb/farming/meat/brahmin/brahmin-location-guide/'),
    ('radstag',           'Radstag Meat Guide',           '/bnb/farming/meat/radstag/radstag-location-guide/'),
    ('radhog',            'Radhog Meat Guide',            '/bnb/farming/meat/radhog/radhog-location-guide/'),
    ('radroach',          'Radroach Meat Guide',          '/bnb/farming/insects/radroach/radroach-location-guide/'),
    ('radrat',            'Radrat Meat Guide',            '/bnb/farming/meat/radrat/radrat-location-guide/'),
    ('bloatfly',          'Bloatfly Meat Guide',          '/bnb/farming/insects/bloatfly/bloatfly-location-guide/'),
    ('bloodbug',          'Bloodbug Meat Guide',          '/bnb/farming/insects/bloodbug/bloodbug-location-guide/'),
    ('gulper',            'Gulper Innards Guide',          '/bnb/farming/meat/gulper/gulper-location-guide/'),
    ('angler',            'Angler Meat Guide',            '/bnb/farming/meat/angler/angler-location-guide/'),
    ('megasloth',         'Megasloth Meat Guide',         '/bnb/farming/meat/megasloth/megasloth-location-guide/'),
    ('wendigo',           'Glowing Meat Guide',           '/bnb/farming/meat/glowing-meat/glowing-meat-location-guide/'),
    ('wolf',              'Wolf Meat Guide',              '/bnb/farming/meat/wolf/wolf-location-guide/'),
    ('ogua',              'Gulper Innards Guide',          '/bnb/farming/meat/gulper/gulper-location-guide/'),
    ('stingwing',         'Bloatfly Meat Guide',          '/bnb/farming/insects/bloatfly/bloatfly-location-guide/'),
]
