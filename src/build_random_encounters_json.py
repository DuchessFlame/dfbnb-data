#!/usr/bin/env python3
"""
build_random_encounters_json.py — Random Encounters
...
the Random Encounters-specific logic.

Usage: python build_random_encounters_json.py
"""
import subprocess, sys, os

def main():
    parent = os.path.join(os.path.dirname(__file__), "build_challenges_json_v3.py")
    print(f"[build_random_encounters_json.py] Delegating to {parent}")
