...
if (-not (Test-Path -LiteralPath $Local)) {
    ...
    Write-Host "Run run_bundle_images.ps1 first."
    exit 1
}
...
Write-Host ""
Write-Host "=== Bundle Images upload (WinSCP) ==="
...
$ScriptPath = Join-Path $env:TEMP "winscp_bundles.txt"
